...
import { ModerationList } from '../moderation/moderation-list'
...
export default async function VerifyPage() {
    ...
    if (itemsError) {
        console.error('[VerifyPage] Items Fetch Error:', itemsError)
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold">Moderation Queue (New)</h1>
